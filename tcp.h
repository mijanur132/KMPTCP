...
//palash below
	u16 total_packet_count;
	u16 loss_packet_count;
	u16 rtt_packet_count;
	u16 rtt_value;
	u16 loss;  
	u16 retransmission_total_packet;
	u16 retransmission_counter;
	u16 retransmission_loss;
	u16 dsack_total;
	u16 dsack_lost;
	u16 dsack_loss;
	u32 total_ack;
	...
	u32 last_ack;
	u32 fast_retransmit;
	u32 current_time_ack;
	u16 retra_loss;
	u32 rtt_sum;
	u32 rtt_avg;
	
        u16  tpc; //palash
	u64 current_time1, current_time2;
	u64 td;
	u64 rate;
